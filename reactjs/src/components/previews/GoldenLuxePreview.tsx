...
import styles from './GoldenLuxePreview.module.css';

interface Props { invitation: Invitation; }

export function GoldenLuxePreview({ invitation }: Props) {
  ...
  return (
    <div className={styles.card}>
      ...
      <p className={styles.label}>Joyfully request the honour of your presence</p>
